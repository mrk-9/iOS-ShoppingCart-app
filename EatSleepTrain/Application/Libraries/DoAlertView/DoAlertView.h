...
// my color
#define DO_TITLE_BOX                DO_RGB(253, 211, 79)
#define DO_NORMAL_BOX               DO_RGB(79, 222, 178)
#define DO_BUTTON_BOX               DO_RGB(31, 31, 31)
...
#define DO_TEXT_FONT [UIFont fontWithName:@"Montserrat-Regular" size:13]
#define DO_BOLD_FONT [UIFont fontWithName:@"Montserrat-Bold" size:13]

#define DO_LABEL_INSET      UIEdgeInsetsMake(24, 10, 24, 10)
#define DO_TITLE_INSET      UIEdgeInsetsMake(10, 8, 10, 8)
