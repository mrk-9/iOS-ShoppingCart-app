...
#import "GIGMyPostedGigTableViewCell.h"

@implementation GIGMyPostedGigTableViewCell
...
- (void) initUI{
    ...
    [commonUtils setRoundedRectView:_postedGigCellView withCornerRadius:6.0f];
